...
Für den Angriff gibt es zwei grundlegende Werte, die \awimp{Attacke (ATK)} wie auch \awimp{Initiative INI}.
...
Wir kennen die folgenden sechs Werte: \hwimp{Stärke (STR)}, \hwimp{Geschicklichkeit (GES)}, \hwimp{Konsitution (KON)}, \hwimp{Intuition (INT)}, \hwimp{Weisheit (WEI)}, \hwimp{Charisma (CHR)}.
