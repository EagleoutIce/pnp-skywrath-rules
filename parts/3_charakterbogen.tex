...
Anschließend können \GP{} eingesetzt werden um die Punkte weiter zu steigern. [Hier kommt noch eine Tabelle, wie diese Steigerung auszusehen hat]
% TODO: skill up
...
\begin{wrapfigure}[4]{r}{0.175\linewidth}
    ...
    \end{tikzpicture}
\end{wrapfigure}
Die \index{Charakter!Wahrnehmung}\imp{Wahrnehmung} ist besonders, da sie nur in vier Stufen gesteigert werden kann. [TODO: Continue]
